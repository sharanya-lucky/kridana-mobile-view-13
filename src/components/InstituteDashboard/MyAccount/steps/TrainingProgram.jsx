    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setFormData({
            programName: data?.trainingProgram?.programName || "",
            ageGroup: data?.trainingProgram?.ageGroup || "",
            skillLevel: data?.trainingProgram?.skillLevel || "",
            batchTimings: data?.trainingProgram?.batchTimings || "",
            duration: data?.trainingProgram?.duration || "",
            fees: data?.trainingProgram?.fees
              ? String(data.trainingProgram.fees)
              : "",
            seatsAvailable: data?.trainingProgram?.seatsAvailable
              ? String(data.trainingProgram.seatsAvailable)
              : "",
            trialSessions: data?.trainingProgram?.trialSessions || "",
          });
        } else {
          // no doc → empty
          setFormData({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await setDoc(
        ...
        { merge: true }, // ✅ keeps other institute fields safe
      );
